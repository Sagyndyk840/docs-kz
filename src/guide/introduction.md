...
:::info Бұл Vue 3 құжаттамасы!

- Vue 2 қолдауы **2023 жылдың 31 желтоқсанында** аяқталды. Кеңейтілген қолдауы бар нұсқа туралы қосымша ақпарат - [Vue 2 EOL](https://v2.vuejs.org/eol/). 
- Vue 2 құжаттамасын мына жерден алуға болады [ru.vuejs.org/v2/](https://ru.vuejs.org/v2/).
- Vue 2-ден көшіп жатырсыз ба? [Көшіру нұсқаулығын](https://v3-migration.vuejs.org/) қараңыз.
:::
